...
:host { all: initial; }
  * { box-sizing: border-box; }
  ...
  .lookup-about-row {
    ...
    flex-direction: column;
    gap: 5px;
    padding: 3px 5px 4px calc(5px + var(--lookup-box-size) + var(--lookup-line-gap));
  ...
  .lookup-about-chip {
    ...
    padding: 2px 7px;
    font-family: inherit;
    font-size: calc(var(--type-second) * var(--bubble-scale, 1) * 0.85);
    color: inherit;
    cursor: pointer;
    text-align: left;
  }
  .lookup-about-chip:hover {
  ...
  .lookup-about-card {
    ...
    border-left: 2.5px solid color-mix(in srgb, currentColor 60%, transparent);
